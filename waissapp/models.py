...
class Farm(models.Model):
    ...
    farm_area = models.DecimalField(max_digits=20, decimal_places=2, verbose_name="Farm Area (sq. m)", null=True, validators=[MinValueValidator(Decimal('0.01'))])
    ...
    lat = models.DecimalField(decimal_places=4, verbose_name="Latitude", null="True", max_digits=6, validators=[MinValueValidator(5), MaxValueValidator(20)])
    long = models.DecimalField(decimal_places=4, verbose_name="Longitude", null="True", max_digits=7, validators=[MinValueValidator(100), MaxValueValidator(130)])
...
class Crop(models.Model):
    ...
    root_ini = models.DecimalField(max_digits=3, decimal_places=2, verbose_name="Root Depth during Transplant (m)", null=True, help_text="Zero (0) if direct-seeded. Equal to the maximum rooting depth if plant is mature.")
...
class Furrow(models.Model):
    ...
    bln_furrow_type = models.BooleanField (verbose_name="Is it an open-ended furrow?", null=True, default=True)
