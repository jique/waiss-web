...
class FarmSummaries(models.Model):
    ...
    basin_sys = models.ForeignKey(BasinPara, on_delete=models.CASCADE, verbose_name="Basin Irrigation", null=True, blank=True)
    border_sys = models.ForeignKey(BorderPara, on_delete=models.CASCADE, verbose_name="Border Irrigation", null=True, blank=True)
    furrow_sys = models.ForeignKey(FurrowPara, on_delete=models.CASCADE, verbose_name="Furrow Irrigation", null=True, blank=True)
    sprinkler_sys = models.ForeignKey(SprinklerPara, on_delete=models.CASCADE, verbose_name="Sprinkler Irrigation", null=True, blank=True)
    drip_sys = models.ForeignKey(DripPara, on_delete=models.CASCADE, verbose_name="Drip Irrigation", null=True, blank=True)
