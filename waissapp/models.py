...
class FieldUnit(models.Model):
    ...
    number = models.CharField(max_length=11, validators=[MinLengthValidator(11)], null=True, verbose_name="Mobile Number (09)")
    fieldunitstatus = models.BooleanField(verbose_name="Field Unit Status", null=True)
    withirrigation = models.BooleanField(verbose_name="With Irrigation (?)", null=True)
    automaticthreshold = models.BooleanField(verbose_name="Automatic Threshold (?)", null=True)
